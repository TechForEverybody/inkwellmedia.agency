...
const ServicesHero: React.FC = () => (
    <section className="relative overflow-hidden py-24">
        ...
        <div className="container mx-auto px-4 flex flex-col-reverse lg:flex-row items-center gap-12" style={{
            marginTop: "50px"
        }}>
            ...
            >
                <h2 className="text-5xl md:text-6xl font-extrabold text-white leading-tight">
                    No longer just services, but excellence of our creativity
                </h2>
            ...
            {/* Image Column */}
            <motion.div
                className="lg:w-1/2 w-full flex justify-center flex-col  "
                initial={{ opacity: 0, x: 60 }}
                whileInView={{ opacity: 1, x: 0 }}
                viewport={{ once: true }}
