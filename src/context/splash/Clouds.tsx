...
const Clouds: React.FC<CloudsProps> = ({ count = 10 }) => {
    ...
    const renderCloud = (cloud: Cloud) => {
        ...
        C52.2,54.2,50.3,60.1,47.2,66.4z" fill="#ffffff35" />
            </svg>,

            // Cloud Type 2: Wide spread cloud
            <svg key="2" viewBox="0 0 240 120" xmlns="http://www.w3.org/2000/svg" width="100%" height="100%">
                <path d="M25,75 Q40,55 60,65 Q70,40 100,50 Q125,30 150,50 Q170,35 190,55 Q215,45 225,65 Q240,75 225,90 Q180,110 100,100 Q40,110 25,75 Z" fill="#ffffff35" />
            </svg>,

            // Cloud Type 3: Small puffy cloud
            <svg key="3" viewBox="0 0 180 100" xmlns="http://www.w3.org/2000/svg" width="100%" height="100%">
                <path d="M35,60 Q45,30 75,50 Q90,20 115,40 Q140,20 155,50 Q180,50 170,70 Q180,90 150,85 Q130,100 100,90 Q70,100 50,80 Q20,80 35,60 Z" fill="#ffffff35" />
            </svg>
        ];
