...
const TargetAudienceData = [
    {
        title: 'Real Estate',
        icon: <img src="/images/paper-style-building-with-people.png" alt="Real Estate Icon" className="w-20 h-20" />,
        description:
    ...
    {
        title: 'E-commerce',
        icon: <img src="/images/ecommerce.png" alt="E-commerce Icon" className="w-20 h-20" />,
        description:
    ...
    {
        title: 'Corporate',
        icon: <img src="/images/managers-are-discussing-business-issues.png" alt="Real Estate Icon" className="w-20 h-20" />,
        description:
    ...
    {
        title: 'Startups',
        icon: <img src="/images/laptop-with-connectivity-5g-tech.png" alt="Startups Icon" className="w-20 h-20" />,
        description:
    ...
    {
        title: 'NGOs & Gov',
        icon: <img src="/images/ngo.png" alt="Real Estate Icon" className="w-20 h-20" />,
        description:
    ...
    {
        title: 'Creators',
        icon: <img src="/images/hand-drawn-male-reporter-character-flat-style-isolated-background.png" alt="Creators Icon" className="w-20 h-20" />,
        description:
    ...
    {
        title: 'Healthcare',
        icon: <img src="/images/digital-health-concept.png" alt="Real Estate Icon" className="w-20 h-20" />,
        description:
    ...
    {
        title: 'Education',
        icon: <img src="/images/Education.png" alt="Real Estate Icon" className="w-20 h-20" />,
        description:
    ...
    {
        title: 'Agencies',
        icon: <img src="/images/agencies.png" alt="Real Estate Icon" className="w-20 h-20" />,
        description:
    ...
    return (
        ...
        >
            <div className="container mx-auto px-4">
                ...
                <p className="text-center text-gray-300 max-w-7xl mx-auto mb-20">
                    ...
                    {TargetAudienceData.map((service, idx) => {
                        ...
                        return (
                            <motion.div
                                ...
                                className="border-white border-2 rounded-lg p-2 flex flex-row  justify-center items-center text-center hover:shadow-lg transition-shadow duration-300 bg-transparent backdrop-blur-5xl hover:bg-white/10 shadow-lg"
                            >
                                <div className="p-0 rounded-full mb-4  mr-5">
                                    {Icon}
                                </div>
                                <div style={{
                                    display: 'flex',
                                    ...
                                    {/* <div className="w-20 h-0.5 bg-accent mb-4"></div> */}
